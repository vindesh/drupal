...
/**
     ...
     */  
    function filterDrilldownTableData(gender, race, afterYear='', year=''){ 
    ...
    */
    ...
    function filterDrilldownData(chart) {
        ...
        if (config.dataType == 'race') {
            ...
            filterDrilldownTableData([gender[0]], race, [filterAfterYear], [year[1]]);//Race - filter
        }
        ...
        if (config.dataType == 'gender') {
            ...
            filterDrilldownTableData(gender, [race[0]], [filterAfterYear], [year[1]]);//Gender - filter
        }
    }
                ...
                $(this).on('change', function() {
                    ...
                    if (series) {
                        ...
                        if(type == 'gender'){
                            ...
                            filterDrilldownTableData(genderFilter, [race[0]],[filterAfterYear], [year[1]]);//Gender filter
                        }else{
                            var raceFilter = race;
                            ...
                            filterDrilldownTableData([gender[0]], raceFilter, [filterAfterYear], [year[1]]);//Race filter
                        }
                    }
                });
            }
            ...
            chart: {
                ...
                events: {
                    ...
                    drilldown: function(e) {
                        ...
                        if (!e.seriesOptions) {
                            var titleYear = parseInt(e.point.options.drillDownName)
                            chart.setTitle({ text: (titleYear-1)+'-'+(titleYear) });
