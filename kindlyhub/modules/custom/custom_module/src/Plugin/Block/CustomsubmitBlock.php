...
/**
 * @file
 * Contains \Drupal\custom_module\Plugin\Block\CustomsubmitBlock.
 */
...
/**
 * Provides a 'Paymentsubmit' block.
 *
 * @Block(
 *   id = "Custom_submit",
 *   admin_label = @Translation("Payment submit block"),
 *   category = @Translation("Custom Payment block example")
 * )
 */
class CustomsubmitBlock extends BlockBase {
  /**
   * {@inheritdoc}
   */
...
//dsm($path_args);
$form = \Drupal::formBuilder()->getForm('Drupal\custom_module\Form\PaymentSubmitForm');
  return $form; 
// return[
// '#markup'=> 'HIII',
// ];
